...
# Create generated clocks from PLL outputs
# clk6x = 48 MHz -> period = 20.83 ns
create_generated_clock -name clk6x -source [get_ports CLOCK_50] \
   -divide_by 50 -multiply_by 48 \
   [get_pins pll_inst|c0]

# clk_25 = 25 MHz -> period = 40.0 ns
create_generated_clock -name clk_25 -source [get_ports CLOCK_50] \
   -divide_by 50 -multiply_by 25 \
   [get_pins pll_inst|c1]
